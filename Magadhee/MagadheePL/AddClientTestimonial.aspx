<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddClientTestimonial.aspx.cs" Inherits="AddClientTestimonial" %>
...
<link rel="stylesheet" type="text/css" href="css/AddClientTestLay.css"/>
...
<div class="banBig">
  ...
  <div class="AddProj" id="AddProjId">
    ...
    Height="16px" onrowcommand="GVClient_RowCommand" Width="440px" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="Client_Test_Id" 
            HeaderText="ID">
