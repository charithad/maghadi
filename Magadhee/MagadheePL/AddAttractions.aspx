<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAttractions.aspx.cs" Inherits="AddAttractions" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<mmeta http-equiv="Content-Type" content="text/html; charset=iso-8859-1"/>
<meta name="keywords" content="security companies in sri lanka"/>
<eta name="keywords" content="provincial and city security service"/>
...
<link rel="stylesheet" type="text/css" href="css/AddAttrLay.css"/>
...
<div class="banBig">
  ...
  <div class="AddProj" id="AddProjId">
    <table width="449" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><h2>edit Attractions</h2></td>
      </tr>
      
      <tr>
        <td><p>Attraction Name</p></td>
      </tr>
      <tr>
        <td style="margin-left:10px;">
            <asp:Panel ID="Panel4" runat="server" Height="183px" Width="459px" >
                <asp:GridView ID="GVAttarct" runat="server" 
    AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" 
    BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" 
    Height="16px" onrowcommand="GVAttr_RowCommand" Width="440px" 
                    EnableModelValidation="True" 
                     >
                    <AlternatingRowStyle BackColor="#F7F7F7" />
                    <Columns>
                        <asp:BoundField DataField="Atraction_Id" 
            HeaderText="ATTRACT ID">
            ...
            HorizontalAlign="Left" VerticalAlign="Middle" Width="75px" />
                        ...
                        <asp:BoundField DataField="Heading" HeaderText="NAME">
                        <HeaderStyle BackColor="#62A8DB" BorderStyle="Solid" BorderWidth="1px" 
      ...
      <tr>
        <td>
        <p>Attraction Id : <asp:Label ID="Label2" runat="server"></asp:Label> 
        <br />
      ...
      <tr>
        <td>
            <p>Attraction Name</p></td>
      </tr>
        
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox5" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p>
          <asp:TextBox ID="TextBox4" runat="server" Height="82px" TextMode="MultiLine" 
      ...
      <tr>
        <td >
      <asp:Panel ID="Panel3" runat="server" Height="192px" Width="207px" 
                                                    ScrollBars="Vertical">
    ...
    Font-Size="Small" Width="139px" EnableModelValidation="True" >
                                                ...
                                                SortExpression="GenreCode" >
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="ChkBang" runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
  ...
  <div class="EditProj" id="EditProjId">
    <table width="449" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>
      <asp:Panel ID="Panel2" runat="server" Height="192px" Width="207px" 
                                                    ScrollBars="Vertical">
    ...
    Font-Size="Small" Width="139px" EnableModelValidation="True">
      ...
      <tr>
        <td>
            <p><asp:Label ID="Label4" runat="server"></asp:Label></p></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
