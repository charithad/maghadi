<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGuestHouse.aspx.cs" Inherits="Add_GuestHouse" %>
...
<title>Add New Guest House</title>

<link rel="stylesheet" type="text/css" href="css/AddGuestLay.css"/>
...
<div class="banBig">
  ...
  <div class="AddProj" id="AddProjId">
    <table width="449" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><p>Guest House Name</p></td>
      </tr>
      <tr>
        <td><p>
            </p>
            <asp:Panel ID="Panel4" runat="server" Height="138px" Width="459px" 
                ScrollBars="Vertical">
                <asp:GridView ID="GVClient" runat="server" AutoGenerateColumns="False" 
                    ...
                    Height="16px" onrowcommand="GVClient_RowCommand" Width="440px">
                    <AlternatingRowStyle BackColor="#F7F7F7" />
                    <Columns>
                        <asp:BoundField DataField="Guest_Code" HeaderText="ID">
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <HeaderStyle BackColor="#62A8DB" BorderStyle="Solid" BorderWidth="1px" 
                                Font-Names="Tahoma" Font-Size="12pt" ForeColor="#00007B" />
                            <ItemStyle Font-Names="Arial" Font-Size="11pt" />
                        </asp:TemplateField>
                    </Columns>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox26" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><p>
          <asp:TextBox ID="TextBox4" runat="server" Height="64px" TextMode="MultiLine" 
                Width="420px" ontextchanged="TextBox4_TextChanged"></asp:TextBox>
        </p></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox10" runat="server"></asp:TextBox></p>
          </td>
      </tr>
      <tr>
        <td><p>Price Of a Room Per Day</p></td>
      </tr>
      <tr>
        <td><p><asp:TextBox ID="TextBox11" runat="server"></asp:TextBox></p></td>
      </tr>
      <tr>
        <td><p>Price Per Day With Breakfast</p></td>
      </tr>
      <tr>
        <td><p><asp:TextBox ID="TextBox16" runat="server"></asp:TextBox></p></td>
      </tr>

      <tr>
        <td><p>Contact_No</p></td>
      </tr>

      <tr>
        <td><p><asp:TextBox ID="TextBox22" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox23" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>

      <tr>
        <td><p>Max-Guests</p></td>
      </tr>

      <tr>
        <td><p><asp:TextBox ID="TextBox24" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox25" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox12" runat="server"></asp:TextBox></p></td>
      </tr>
      <tr>
        <td><p>Upload pics 1366X500</p></td>
      </tr>
      <tr>
        <td><p>
      ...
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox7" runat="server" Width="420px"></asp:TextBox></p>
          </td>
      </tr>
      ...
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox8" runat="server" Width="420px"></asp:TextBox></p>
          </td>
      </tr>
      ...
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox9" runat="server" Width="420px"></asp:TextBox></p>
          </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <div id="butEditEdit">
            <asp:ImageButton ID="ImageButton4" runat="server" 
                ImageUrl="~/Common/Images/delete.png" onclick="ImageButton4_Click" 
                Width="100px"/></div>
  ...
  <div class="EditProj" id="EditProjId">
    <table width="449" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><h2>Add Guest House</h2></td>
      </tr>
      <tr>
        <td><p>Guest House name
      ...
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox13" runat="server"></asp:TextBox></p>
          </td>
      </tr>
      <tr>
        <td><p>Price Of a Room Per Day</p></td>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox14" runat="server"></asp:TextBox></p></td>
      </tr>
      <tr>
        <td ><p>Number Of rooms</p></td>
      </tr>
      <tr>
        <td><p><asp:TextBox ID="TextBox15" runat="server"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox17" runat="server"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox18" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox19" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox20" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:TextBox ID="TextBox21" runat="server" Width="420px"></asp:TextBox></p></td>
      </tr>
      ...
      <tr>
        <td><p><asp:FileUpload ID="FileUpload3" runat="server" /></p></td>
      </tr>
      <tr>
        <td><p><asp:FileUpload ID="FileUpload4" runat="server" /></p></td>
      </tr>
      <tr>
        <td><p>Wording 1</p></td>
      </tr>
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox3" runat="server" Width="420px" 
                    ontextchanged="TextBox3_TextChanged"></asp:TextBox></p>
          </td>
      </tr>
      ...
      <tr>
        <td>
            <p><asp:TextBox ID="TextBox5" runat="server" Width="420px" 
                    ontextchanged="TextBox5_TextChanged"></asp:TextBox></p>
          </td>
      </tr>
